  ...
  try {
    const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        temperature: 0.3,
        messages: [
          { role: "system", content: system || "You are an expert Roblox Lua developer. Generate complete working Lua code." },
...
app.listen(PORT, () => {
  ...
  console.log("Groq AI: " + (process.env.GROQ_API_KEY ? "OK" : "MISSING KEY!"));
});
